...
- 能與產品經理、設計師討論 Mockup、Prototype，提出規格上的建議及易用性的前端介面建議。 
...
- 使用 Crashlytics 錯誤回報軟體，有效的監控程式錯誤，立即排除線上問題。
- 進行軟體之測試、修改、上架與維護。
...
大家好，我是陳姿羽，是軟體工程師，畢業於大同大學 - 資訊經營研究所，從事軟體開發五年，從六年前開始，自學手機程式，從完全不會，到後來成為金融公司的應用開發工程師與襄理，也曾在勞委會職訓課程，擔任 APP 程式教學助教，指導超過百位學生。上線的產品有《股票快選APP》、《股票抽籤APP》、《線上開戶APP》、《法人業務APP》... 等眾多與眾不同的 APP。如此，令人驚豔的產品，不僅榮獲《經濟部工業局》「數位內容產品獎─網路服務類」肯定，也榮獲《數位時代》 「商務創新獎」「最佳客戶體驗-優勝」。
...
能夠使用 HTML、CSS、JavaScript、jQuery 技術，做出 RWD 響應式的互動網頁，兼容手機與平板，並且透過 JSON、AJAX 介接 Open Data API 資料，實作出高雄旅遊網站。不僅於此，能根據網站需求，建立關聯式的資料庫與資料表，設計出 DB Schema 規格，接著，再將前端設計的版型，套用到後端 ASP.NET 程式，透過對 T-SQL 語法瞭解，能將資料庫與 ADO.NET 串接，完成具有存取 (查詢/新增/修改/刪除) 資料與 RWD 響應式互動效果的網站，最後，把網站部署到 IIS 或是 Microsoft Azure 雲端平台。
